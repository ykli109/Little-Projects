...
/**
 * If `w > 1`, the maximum amount of time to wait for this write to propagate
 * through the replica set before this operation fails. The default is `0`,
...
Query.prototype.wtimeout = function wtimeout(val) {
  if (val == null) {
    delete this.options.wtimeout;
  }
  this.options.wtimeout = val;
  return this;
};
